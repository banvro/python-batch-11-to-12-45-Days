...
class ContactUs(models.Model):
    ...
    img = models.ImageField(upload_to="contactus_images", null=True, blank=True)
...
choice = [
    ...
    ("Tester", "Tester"),
    ("Full-Stack Devloper", "Full-Stack Devloper")
    ]
...
class Employee(models.Model):
    ...
    e_img = models.ImageField(upload_to="employe_images", null=True, blank=True)

    def __str__(self):
        return f"{self.e_name} --> {self.e_branch}"